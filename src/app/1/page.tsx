  ...
  const visuals: Record<string, React.ReactNode> = {
    ...
    photo1: (
      <svg viewBox={vb} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio={pr} style={shared}>
        ...
        <text x="80" y="120" fontFamily="system-ui" fontSize="16" fill="rgba(255,255,255,.5)" letterSpacing="8">RASTATT 06:42</text>
      </svg>
    ),
    photo2: (
      <svg viewBox={vb} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio={pr} style={shared}>
  ...
  return (
    ...
    >
      ...
      <div className="p1-hero__rail p1-hero__rail--l" aria-hidden="true">
        <span>N 48.858700°</span><span>E 8.207600°</span><span>RASTATT · DE</span>
      </div>
      <div className="p1-hero__rail p1-hero__rail--r" aria-hidden="true">
        <span>{time}</span><span>SINCE 2024</span><span>STUDIO ONE</span>
      </div>
      ...
      <div className="p1-hero__inner">
        ...
        <div className={`p1-hero__meta p1-reveal ${mounted ? 'is-in' : ''}`} style={{ transitionDelay: '440ms' }}>
          ...
          <div className="p1-hero__meta-cell">
            ...
            <div className="p1-hero__meta-value"><span className="p1-hero__dot" /> Verfügbar Q2/26</div>
          </div>
        </div>
      </div>
...
function P1Marquee({ dark = false }: { dark?: boolean }) {
  const items = ['Editorial Webdesign','Brand Systems','Conversion-Optimiert','DACH-Region','Webentwicklung','Made in Rastatt','Premium Marken','Strategie & Code'];
      ...
      <div className="p1-container">
        <div className="p1-footer__grid">
          <div className="p1-footer__brand">
            ...
            <p className="p1-footer__about">Eine Webdesign-Agentur in Rastatt. Spezialisiert auf editoriales Design, Marken-Systeme und sauber gebaute Websites.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="p1-footer__list"><li>philipp@pauli-one.de</li><li>@paulione.wd</li><li>www.pauli-one.de</li><li>Rastatt, DE</li></ul>
          </div>
        </div>
